...
class Wavelet {
	...
	cv::Mat hp = (cv::Mat_<float>(1, 7) << 0.0456358815570000, -0.0287717631140000, -0.295635881557000, 0.557543526229000, -0.295635881557000, -0.0287717631140000, 0.0456358815570000);
	cv::Mat lpr = (cv::Mat_<float>(1, 7) << -0.0912717631140000, -0.0575435262280000, 0.591271763114000, 1.11508705245800, 0.591271763114000, -0.0575435262280000, -0.0912717631140000);
...
public:
	...
	void upsample(cv::Mat&, cv::Mat&, int rowCol, int start); // start is either 0 or 1
};
